...
Escape room educativo en HTML, CSS y JavaScript, con estética de fantasía: azul nocturno, cristal, detalles dorados y tipografía ornamental. Seis habitaciones; las dos primeras tienen retos completos y las otras cuatro reservan futuros desafíos. Vista 2.5D por raycasting con objetos dibujados en canvas, sin dependencias externas.
...
2. Pulsa **Colocar bala en el cañón**, o toca el cañón de la escena después de elegirla. La recámara se ilumina con su color. La torreta Prisma tiene una base hexagonal y un cabezal de cristal, sin tubo largo ni ruedas.
...
- WASD: caminar; flechas izquierda/derecha: girar la cámara.
- Espacio: disparar o interactuar con la mesa en la segunda sala.
- E: interactuar con la mesa. En móvil hay botones de movimiento.
...
- `src/engine/renderer.js`: raycasting, cañón, pantalla y mesa/ruleta.
...
- `src/ui/styles.css`: tema e interfaz adaptable.
...
Un solo repositorio Git local, sin remoto. El progreso y los intentos viven en memoria; se reinician al recargar. Las salas 03–06 mantienen puertas de boceto que se abren con un disparo.
